...
class KosuSayfasi extends StatefulWidget {
  const KosuSayfasi({super.key});

  @override
  State<KosuSayfasi> createState() => _KosuSayfasiState();
}

class _KosuSayfasiState extends State<KosuSayfasi>
  ...
  Future<void> _kaydetKosuVerisi({bool timerRunning = false}) async {
    try {
      await FirebaseFirestore.instance.collection('kosu_verileri').add({
        'zaman': seconds,
        'kalori': calories,
  ...
  void stopTimer() {
    ...
    _kaydetKosuVerisi(timerRunning: false);
  }
